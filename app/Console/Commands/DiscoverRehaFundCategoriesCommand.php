...
final class DiscoverRehaFundCategoriesCommand extends Command
{
    protected $signature = 'rehafund:categories
        ...
        {--page-limit=250 : Maximum RehaFund category pages to visit while discovering nested categories.}
        {--request-delay-ms=500 : Milliseconds to pause before each RehaFund HTTP request.}';

    protected $description = 'Discover RehaFund category hierarchy and product-scraping category URLs.';

    public function __construct(
        private readonly RehaFundCategoryUrlScraper $scraper,
    ) {
        parent::__construct();
    }
    ...
    public function handle(): int
    {
        ...
        $this->info('Discovering RehaFund category hierarchy...');
