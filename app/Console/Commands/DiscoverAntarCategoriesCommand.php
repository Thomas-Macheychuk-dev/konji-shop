...
final class DiscoverAntarCategoriesCommand extends Command
{
    protected $signature = 'antar:categories
    ...
    public function __construct(
        private readonly AntarCategoryUrlScraper $scraper,
    ) {
        parent::__construct();
    }
    ...
    public function handle(): int
    {
        ...
        $this->info('Discovering Antar category hierarchy...');
