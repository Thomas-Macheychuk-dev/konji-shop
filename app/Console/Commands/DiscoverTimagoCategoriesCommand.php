...
final class DiscoverTimagoCategoriesCommand extends Command
{
    protected $signature = 'timago:categories
    ...
    protected $description = 'Discover Timago category hierarchy and product-scraping category URLs.';

    public function __construct(
        private readonly TimagoCategoryUrlScraper $scraper,
    ) {
        parent::__construct();
    }
    ...
    public function handle(): int
    {
        ...
        $this->info('Discovering Timago category hierarchy...');
