...
final class DiscoverMedRehaCategoriesCommand extends Command
{
    protected $signature = 'medreha:categories
    ...
    protected $description = 'Discover MedReha category hierarchy and product-scraping category URLs.';

    public function __construct(
        private readonly MedRehaCategoryUrlScraper $scraper,
    ) {
        parent::__construct();
    }
    ...
    public function handle(): int
    {
        ...
        $this->info('Discovering MedReha category hierarchy...');
