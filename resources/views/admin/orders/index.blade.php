...
@section('content')
    <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div class="mb-8">
            <h1 class="text-3xl font-bold tracking-tight text-zinc-900">Orders</h1>
        ...
        <div class="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm">
            <form method="GET" action="{{ route('admin.orders.index') }}" class="mb-6 grid gap-3 rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm sm:grid-cols-5">
                ...
                <div>
                    <label for="payment_status" class="block text-sm font-medium text-zinc-700">Payment</label>
                ...
                <div>
                    <label for="fulfilment_status" class="block text-sm font-medium text-zinc-700">Fulfilment</label>
            ...
            <table class="min-w-full divide-y divide-zinc-200">
                ...
                <tr>
                    <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-zinc-500">Order</th>
                    <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-zinc-500">Customer</th>
                    <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-zinc-500">Status</th>
                    <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-zinc-500">Payment</th>
                    <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-zinc-500">Fulfilment</th>
