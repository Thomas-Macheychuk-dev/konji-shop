...
it('shows the admin product edit page with variants', function (): void {
    ...
    $this
        ...
        ->assertSee('Edytor Trix + kod HTML + podgląd')
        ->assertSee('Kod HTML zapisywany w produkcie')
        ->assertSee('Edytor wizualny Trix')
        ->assertSee('Podgląd HTML')
        ->assertSee('trix-editor', false)
        ->assertSee('data-html-description-preview', false)
